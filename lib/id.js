...
class Id {
  ...
  /**
   * Returns boolean indicating whether the id equals the other id.
   *
   * @param  {Id}       id
   * @return {boolean}
   */
  ...
  /**
   * Returns an id that is half of this id.
   *
   * @return {Id}
   */
  halve() {
  ...
  /**
   * Adds the id to another id and returns the result.
   *
   * @param  {Id} id
   * @return {Id}
   */
  ...
  /**
   * Subtracts another id from the id and returns the result.
   *
   * @param  {Id} id
   * @return {Id}
   */
  ...
  /**
   * Multiplies id by another id returns the product.
   *
   * @param  {Id} id
   * @return {Id}
   */
  ...
  /**
   * Divides id by another id and returns object with quotient and remainder.
   *
   * @param  {Id}     id
   * @return {Object}
   */
